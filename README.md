...
### 扩展
受上述启发，可以开多个gost进程，进行用户管理，将主代理隐藏，甚至当主代理在本机时也可如此，例如：
```bash
# 代理1
gost -L=:11087 -F=http://192.168.1.155:11087

# 代理2
gost -L=:21087 -F=http://192.168.1.155:11087

# 代理3
gost -L=:31087 -F=http://192.168.1.155:11087
```
